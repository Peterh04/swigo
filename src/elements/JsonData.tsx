...
export const HomeSpacialMenunArr = [
  {
    ...
    title: "Cheese Pizza",
    description:
      "Tomato concasse, mozzarella cheese, feta cheese, black olives, vegetables, oregano and basil.",
  },
  {
    ...
    title: "Fried Rice",
    description:
      "Fragrant basmati rice cooked with juicy chicken and authentic biriyani spices",
  },
  {
    name: "Bacon Salad",
    price: "UGX 30,000.00",
    ...
    title: "Green Salad",
    description:
      "fried bacon , roasted chick peas ,tomato cucumber and lettuce",
  },
  {
    ...
    description:
      "Penne pasta, with chicken strips in a creamy sauce, garnished with cheese.",
  },
];
...
export const MenuStyle4Arr = [
  ...
  {
    categery: "ALL BURGER",
    img: IMAGES.chicken_sandwich,
    name: "Chicken Sandwich",
    price: "UGX 42,000",
    short_description: "Juicy and Tender",
  },
  {
    categery: "ALL BURGER",
    img: IMAGES.Steak_sandwich,
    name: "Steak Sandwich",
    price: "UGX 42,000",
    short_description: "Savory and Rich",
  },
  {
    categery: "ALL BURGER",
    img: IMAGES.avocado_melt_sandwich,
    name: "Avocado Melt Sandwich",
    price: "UGX 36,000",
    short_description: "Creamy and Fresh",
  },
  {
    categery: "ALL BURGER",
    img: IMAGES.chicken_wrap,
    name: "Chicken Wrap",
    price: "UGX 20,000",
    short_description: "Juicy and Soft",
  },
  {
    categery: "ALL BURGER",
    img: IMAGES.mexican_wrap,
    name: "Mexican Wrap",
    price: "UGX 23,000",
    short_description: "Spicy and Bold",
  },
  {
    categery: "ALL BURGER",
    img: IMAGES.quesadilla,
    name: "Quesadilla",
    price: "UGX 20,000",
    short_description: "Cheesy and Warm",
  },
  {
    categery: "ALL BURGER",
    img: IMAGES.greek_wrap,
    name: "Greek Wrap",
    price: "UGX 25,000",
    short_description: "Fresh and Tangy",
  },
  {
    categery: "ALL BURGER",
    img: IMAGES.chicken_burger,
    name: "Chicken Burger",
    price: "UGX 40,000",
    short_description: "Grilled and Juicy",
  },
  {
    categery: "ALL BURGER",
    img: IMAGES.beef_burger,
    name: "Beef Burger",
    price: "UGX 40,000",
    short_description: "Juicy and Rich",
  },

  // Pizza
  {
    categery: "ALL PIZZA",
    img: IMAGES.margherita_pizza,
    name: "Margherita Pizza",
    price: "UGX 35,000",
    short_description: "Classic and Fresh",
  },
  {
    categery: "ALL PIZZA",
    img: IMAGES.chicken_pollo_pizza,
    name: "Chicken Pollo Pizza",
    price: "UGX 40,000",
    short_description: "Cheesy and Savory",
  },
  {
    categery: "ALL PIZZA",
    img: IMAGES.hawaiian_pizza,
    name: "Hawaiian Pizza",
    price: "UGX 40,000",
    short_description: "Sweet and Smoky",
  },
  {
    categery: "ALL PIZZA",
    img: IMAGES.ladenia_pizza,
    name: "Ladenia Pizza",
    price: "UGX 40,000",
  ...
  {
    categery: "ALL SALAD",
    img: IMAGES.chicken_caesar_salad,
    name: "Chicken Caesar Salad",
    price: "UGX 30,000",
    short_description: "Fresh and Crisp",
  },
  {
    categery: "ALL SALAD",
    img: IMAGES.greek_salad,
    name: "Greek Salad",
    price: "UGX 20,000",
    short_description: "Light and Fresh",
  },
  {
    categery: "ALL SALAD",
    img: IMAGES.cobb_salad,
    name: "Cobb Salad",
    price: "UGX 25,000",
    short_description: "Healthy and Fresh",
  },
  {
    categery: "ALL SALAD",
    img: IMAGES.chicken_biriyani_rice,
    name: "Chicken Biriyani Rice",
    price: "UGX 30,000",
    short_description: "Spiced and Aromatic",
  },
  {
    categery: "ALL SALAD",
    img: IMAGES.pilawo_rice,
    name: "Pilawo Rice",
    price: "UGX 20,000",
    short_description: "Fragrant and Warm",
  },
  {
    categery: "ALL SALAD",
    ...
    name: "Coconut Rice",
    price: "UGX 20,000",
    short_description: "Creamy and Soft",
  },
  {
    categery: "ALL SALAD",
  ...
  {
    categery: "ALL SALAD",
    img: IMAGES.mac_n_cheese,
    name: "Mac N Cheese",
    price: "UGX 30,000",
    short_description: "Creamy and Cheesy",
  },
  {
    categery: "ALL SALAD",
    img: IMAGES.grilled_tilapia_fillet,
    name: "Grilled Tilapia Fillet",
    price: "UGX 63,000",
    short_description: "Fresh and Grilled",
  },
  {
    categery: "ALL SALAD",
    img: IMAGES.coconut_fish_fillet,
    name: "Coconut Fish Fillet",
    price: "UGX 63,000",
    short_description: "Soft and Creamy",
  },
  {
    categery: "ALL SALAD",
    img: IMAGES.whole_tilapia_fish,
    name: "Whole Tilapia Fish",
    price: "UGX 55,000",
    short_description: "Whole and Fresh",
  },
  ...
  // ================= SPICY =================
  {
    ...
    name: "Chicken Curry",
    price: "UGX 28,000",
    short_description: "Spicy and Rich",
  },
  {
    categery: "ALL SPICY",
    img: IMAGES.vegetable_curry,
    name: "Vegetable Curry",
    price: "UGX 25,000",
    short_description: "Healthy and Spicy",
  },
  {
    categery: "ALL SPICY",
    img: IMAGES.fish_curry,
    name: "Fish Curry",
    price: "UGX 30,000",
    short_description: "Hot and Flavorful",
  },
  {
    categery: "ALL SPICY",
    img: IMAGES.grilled_beef_steak,
    name: "Grilled Beef Steak",
    price: "UGX 62,000",
    short_description: "Juicy and Grilled",
  },
  {
    categery: "ALL SPICY",
    img: IMAGES.beef_brochette,
    name: "Beef Brochette",
    price: "UGX 65,000",
    short_description: "Grilled and Spiced",
  },
  {
    categery: "ALL SPICY",
    img: IMAGES.pork_ribs,
    name: "Pork Ribs",
    price: "UGX 75,000",
    short_description: "Smoky and Tender",
  },
  {
    categery: "ALL SPICY",
    img: IMAGES.french_fries,
    name: "French Fries",
    price: "UGX 10,000",
    short_description: "Crispy and Golden",
  },
  {
    categery: "ALL SPICY",
  ...
  {
    categery: "ALL SWEETS",
    img: IMAGES.ice_cream_scoop,
    name: "Ice Cream Scoop",
    price: "UGX 8,000",
    short_description: "Cold and Creamy",
  },
  {
    categery: "ALL SWEETS",
    img: IMAGES.menu_small_pic4,
    name: "Cake Slice of the Day",
    price: "UGX 10,000",
    short_description: "Soft and Sweet",
  },
  {
    categery: "ALL SWEETS",
    img: IMAGES.pancakes_and_crepes,
    name: "Pancakes and Crepes",
    price: "UGX 15,000",
    short_description: "Soft and Fluffy",
  },

  // ================= COLD DRINK =================
  {
    categery: "ALL COLD DRINK",
    img: IMAGES.mango_smoothie,
    name: "Mango Smoothie",
    price: "UGX 19,000",
  ...
  {
    categery: "ALL COLD DRINK",
    img: IMAGES.banana_smoothie,
    name: "Banana Smoothie",
    price: "UGX 19,000",
    short_description: "Creamy and Smooth",
  },
  {
    categery: "ALL COLD DRINK",
    img: IMAGES.milk_shake,
    name: "Milk Shake",
    price: "UGX 19,000",
    short_description: "Cold and Sweet",
  },
  {
    categery: "ALL COLD DRINK",
    ...
    price: "UGX 16,000",
    short_description: "Fresh and Zesty",
  },
  {
    categery: "ALL COLD DRINK",
    img: IMAGES.watermelon_juice,
    name: "Watermelon Juice",
    price: "UGX 16,000",
    short_description: "Cold and Refreshing",
  },
  {
    categery: "ALL COLD DRINK",
    img: IMAGES.passion_juice,
  ...
  {
    categery: "ALL COLD DRINK",
    img: IMAGES.tropical_orange,
    name: "Tropical Orange",
    price: "UGX 18,000",
    short_description: "Citrus and Fresh",
  },
];
